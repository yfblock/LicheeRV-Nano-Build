	...
	struct isp_i2c_data *i2c_data)
{
	...
	pr_info("set drop frame info: raw_num=%d, drop_frm_cnt=%d\n", raw_num, i2c_data->drop_frame_cnt);
...
{
	switch (id) {
	case VI_IOCTL_ONLINE: return "VI_IOCTL_ONLINE";
	case VI_IOCTL_HDR: return "VI_IOCTL_HDR";
	case VI_IOCTL_3DNR: return "VI_IOCTL_3DNR";
	case VI_IOCTL_TILE: return "VI_IOCTL_TILE";
	case VI_IOCTL_COMPRESS_EN: return "VI_IOCTL_COMPRESS_EN";
	case VI_IOCTL_STS_MEM: return "VI_IOCTL_STS_MEM";
	case VI_IOCTL_STS_GET: return "VI_IOCTL_STS_GET";
	case VI_IOCTL_STS_PUT: return "VI_IOCTL_STS_PUT";
	case VI_IOCTL_POST_STS_GET: return "VI_IOCTL_POST_STS_GET";
	case VI_IOCTL_POST_STS_PUT: return "VI_IOCTL_POST_STS_PUT";
	case VI_IOCTL_USR_PIC_CFG: return "VI_IOCTL_USR_PIC_CFG";
	case VI_IOCTL_USR_PIC_ONOFF: return "VI_IOCTL_USR_PIC_ONOFF";
	case VI_IOCTL_USR_PIC_PUT: return "VI_IOCTL_USR_PIC_PUT";
	case VI_IOCTL_AE_CFG: return "VI_IOCTL_AE_CFG";
	case VI_IOCTL_AWB_CFG: return "VI_IOCTL_AWB_CFG";
	case VI_IOCTL_AF_CFG: return "VI_IOCTL_AF_CFG";
	case VI_IOCTL_USR_PIC_TIMING: return "VI_IOCTL_USR_PIC_TIMING";
	case VI_IOCTL_GET_LSC_PHY_BUF: return "VI_IOCTL_GET_LSC_PHY_BUF";
	case VI_IOCTL_CSIBDG_CFG: return "VI_IOCTL_CSIBDG_CFG";
	case VI_IOCTL_GET_TUN_ADDR: return "VI_IOCTL_GET_TUN_ADDR";
	case VI_IOCTL_SET_SNR_INFO: return "VI_IOCTL_SET_SNR_INFO";
	case VI_IOCTL_SET_SNR_CFG_NODE: return "VI_IOCTL_SET_SNR_CFG_NODE";
	case VI_IOCTL_GET_PIPE_DUMP: return "VI_IOCTL_GET_PIPE_DUMP";
	case VI_IOCTL_PUT_PIPE_DUMP: return "VI_IOCTL_PUT_PIPE_DUMP";
	case VI_IOCTL_SET_RGBMAP_IDX: return "VI_IOCTL_SET_RGBMAP_IDX";
	case VI_IOCTL_HDR_DETAIL_EN: return "VI_IOCTL_HDR_DETAIL_EN";
	case VI_IOCTL_YUV_BYPASS_PATH: return "VI_IOCTL_YUV_BYPASS_PATH";
	case VI_IOCTL_BE_ONLINE: return "VI_IOCTL_BE_ONLINE";
	case VI_IOCTL_SUBLVDS_PATH: return "VI_IOCTL_SUBLVDS_PATH";
	case VI_IOCTL_GET_IP_INFO: return "VI_IOCTL_GET_IP_INFO";
	case VI_IOCTL_TRIG_PRERAW: return "VI_IOCTL_TRIG_PRERAW";
	case VI_IOCTL_SET_PROC_CONTENT: return "VI_IOCTL_SET_PROC_CONTENT";
	case VI_IOCTL_SC_ONLINE: return "VI_IOCTL_SC_ONLINE";
	case VI_IOCTL_MMAP_GRID_SIZE: return "VI_IOCTL_MMAP_GRID_SIZE";
	case VI_IOCTL_RGBIR: return "VI_IOCTL_RGBIR";
	case VI_IOCTL_AWB_STS_GET: return "VI_IOCTL_AWB_STS_GET";
	case VI_IOCTL_AWB_STS_PUT: return "VI_IOCTL_AWB_STS_PUT";
	case VI_IOCTL_GET_FSWDR_PHY_BUF: return "VI_IOCTL_GET_FSWDR_PHY_BUF";
	case VI_IOCTL_GET_SCENE_INFO: return "VI_IOCTL_GET_SCENE_INFO";
	case VI_IOCTL_CLK_CTRL: return "VI_IOCTL_CLK_CTRL";
	case VI_IOCTL_GET_BUF_SIZE: return "VI_IOCTL_GET_BUF_SIZE";
	case VI_IOCTL_SET_DMA_BUF_INFO: return "VI_IOCTL_SET_DMA_BUF_INFO";
	case VI_IOCTL_ENQ_BUF: return "VI_IOCTL_ENQ_BUF";
	case VI_IOCTL_DQEVENT: return "VI_IOCTL_DQEVENT";
	case VI_IOCTL_START_STREAMING: return "VI_IOCTL_START_STREAMING";
	case VI_IOCTL_STOP_STREAMING: return "VI_IOCTL_STOP_STREAMING";
	case VI_IOCTL_SET_SLICE_BUF_EN: return "VI_IOCTL_SET_SLICE_BUF_EN";
	case VI_IOCTL_GET_CLUT_TBL_IDX: return "VI_IOCTL_GET_CLUT_TBL_IDX";
	case VI_IOCTL_SDK_CTRL: return "VI_IOCTL_SDK_CTRL";
	case VI_IOCTL_GET_RGBMAP_LE_PHY_BUF: return "VI_IOCTL_GET_RGBMAP_LE_PHY_BUF";
	case VI_IOCTL_GET_RGBMAP_SE_PHY_BUF: return "VI_IOCTL_GET_RGBMAP_SE_PHY_BUF";
	default: return "VI_IOCTL_unknown";
	}
}
